...
@Profile("!kafka")
@Service("shuffleRestService")
public class ShuffleRestServiceImpl implements ShuffleService {

    private final ShuffledData data;
    private final LogService logService;

    public ShuffleRestServiceImpl(@Qualifier("logRestService") LogService logService,
                              ShuffledData data) {
